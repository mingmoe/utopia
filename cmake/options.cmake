...
# clang tidy设置
if(U_DEBUG_MODE)
    option(U_OPT_CLANG_TIDY "using clang-tidy? default enable in debug" ON)
elseif(U_RELEASE_MODE)
    option(U_OPT_CLANG_TIDY "using clang-tidy? default enable in debug" OFF)
endif()

option(U_OPT_CLANG_TIDY_PATH "clang-tidy path? default value is clang-tidy" "clang-tidy")
