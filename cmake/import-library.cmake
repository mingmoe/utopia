...
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/tribool/include")
...
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/logic/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/mp11/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/integer/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/enable_if/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/safe_numerics/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/concept_check/include")
target_include_directories(boost SYSTEM INTERFACE "${UTOPIA_LIBRARY}/boost/libs/preprocessor/include")
